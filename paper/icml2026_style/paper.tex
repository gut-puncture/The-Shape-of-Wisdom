...
% Short running title (must fit in header)
\icmltitlerunning{State, Motion, Boundary}

\begin{document}

\twocolumn[
  \icmltitle{State, Motion, Boundary: A Mechanistic Account of\\
    Convergence and Failure in Transformer Multiple-Choice Decisions}
  ...
  \icmlkeywords{mechanistic interpretability, transformer dynamics, decision trajectories, logit margin, attention routing, MLP injection}
...
% Override the running title after \icmltitle has run.
% The icml2026.sty vbox height check (6.25pt threshold) incorrectly
% triggers for any non-empty title in \small\bf, so we force it here.
\makeatletter
\gdef\@icmltitlerunning{State, Motion, Boundary}
\makeatother
...
%% 4. PHASE DIAGRAM
%% ============================================================
\section{Phase Diagram of Convergence}
\label{sec:phase}
...
%% ============================================================
\section{Opening the Box: Two-Force Decomposition}
